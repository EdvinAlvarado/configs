...
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'c', callback = function() vim.keymap.set('n', '<c-b>', '<cmd>make<cr>') end })
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'c', callback = function() vim.keymap.set('n', '<c-c>', 'I// <esc>') end })
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'c', callback = function() vim.keymap.set('n', '<c-x>', '<home>xxx') end })
-- python
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'python', callback = function() vim.keymap.set('n', '<c-c>', 'I# <esc>') end })
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'python', callback = function() vim.keymap.set('n', '<c-x>', '<home>xx') end })
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'python', callback = function() vim.keymap.set('v', '<c-c>', 'I# <esc>') end })
-- rust
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'rust', callback = function() vim.keymap.set('n', '<c-b>', '<cmd>w<cr>' .. '<cmd>!cargo build<cr>') end })
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'rust', callback = function() vim.keymap.set('n', '<c-r>', '<cmd>w<cr>' .. '<cmd>!cargo run<cr>') end })
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'rust', callback = function() vim.keymap.set('n', '<c-t>', '<cmd>w<cr>' .. '<cmd>!cargo test<cr>') end })
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'rust', callback = function() vim.keymap.set('n', '<c-c>', 'I// <esc>') end })
vim.api.nvim_create_autocmd("FileType",
	{ pattern = 'rust', callback = function() vim.keymap.set('n', '<c-x>', '<home>xxx') end })
-- apl
...
Lsps = { "rust_analyzer", "pyright", "gopls", "lua_ls", "texlab", "taplo", "yamlls", "clangd", "jsonls", "html",
	"pest_ls", "zls" }
	...
	},
	{
		...
		config = function()
			...
			configs.setup({
				...
				ensure_installed = { 'c', 'lua', 'vim', 'vimdoc', 'query', 'html', 'rust', 'go', 'python', 'toml',
					'cmake', 'make', 'csv', 'json', 'latex' },
			...
			rt.setup({
				...
				server = {
					on_attach = function(_, bufnr)
						-- Hover actions
						vim.keymap.set("n", "<C-s>", rt.hover_actions.hover_actions,
							{ buffer = bufnr, desc = "hover actions" })
						-- Code action groups
						vim.keymap.set("n", "<C-a>", rt.code_action_group.code_action_group,
